...
const Post = ({ buyNow, addToCart, product, variants }) => {
  ...
  const checkServiceabillity = async () => {
    ...
    if (pinJson.includes(parseInt(pin))) {
      ...
      setService(false);
      toast.error("Sorry !Service not applicable in your area ", {
        position: "bottom-center",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">
                  {product.tittle}({product.size}/{product.color})
                </h1>
                        ...
                        <button
                          ...
                          className={`border-2 ${
                            color === "purple"
                              ? "border-black"
                              : "border-gray-300"
                          } bg-purple-400 rounded-full w-6 h-6 focus:outline-none`}
                        ></button>
                      )}
                    {Object.keys(variants).includes("red") &&
                      Object.keys(variants["red"]).includes(size) && (
                        <button
                          ...
                          } ml-1 bg-red-700 rounded-full w-6 h-6 focus:outline-none`}
                        ></button>
                      )}
